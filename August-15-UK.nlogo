...
to setup
  ...
  set d-rate2 (100 * (last c-d / item 4 popsizes)) ;; @@@@@@@@@@@@@@
...
;---------------------
to-report popsize
  report [ ["world" 7781173000] ["PRC" 1393000000] ["USA" 328200000]
           ["F" 65263122] ["UK" 67869798] ["NL" 17430955] ["BR" 212574666]]
end
;---------------------
...
"" ""
PENS
"raster" 1.0 0 -3026479 true "" "if  ticks = 9 or ticks = 14 \nor ticks = 15 or ticks = 19 or ticks = 27\n[ plot-pen-up plotxy ticks 0 \n  plot-pen-down plotxy ticks 11110000]"
...
1051
343
Graph 2: New Cases/5 with New Deaths
weeks
people 
0.0
34.0
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "ifelse ticks > root-shft and ticks <= (xmax) \n[plot-pen-down plot item ticks d-i / 5] [plot-pen-up plot 0]"
"pen-1" 1.0 0 -3026479 true "" "if ticks = 9 or ticks = 14 or ticks = 15 or ticks = 19 or ticks = 27\n[plot-pen-up plotxy ticks 0 plot-pen-down plotxy ticks 5000000]"
"pen-2" 1.0 0 -5298144 true "" "ifelse ticks > root-shft and ticks <= (xmax) \n[plot-pen-down plot item ticks d-d ] \n[plot-pen-up plot 0]"
