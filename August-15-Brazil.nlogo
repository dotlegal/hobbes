...
to setup
  ...
  set d-rate2 (100 * (last c-d / item 6 popsizes))  ;;@@@@@@@@@@@@
...
982
339
Graph 2: New Cases / 17 with New Deaths per Week
weeks
people 
0.0
34.0
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "ifelse ticks > 0 and ticks <= (xmax) \n[plot-pen-down plot item ticks d-i / 17 ] [plot-pen-up plot 0]"
"pen-1" 1.0 0 -3026479 true "" "if ticks = 16 or ticks = 9 or ticks = 23\n[plot-pen-up plotxy ticks 0 plot-pen-down plotxy ticks 5000000]"
"pen-2" 1.0 0 -2674135 true "" "ifelse ticks > 0 and ticks <= (xmax) \n[plot-pen-down plot item ticks d-d ] \n[plot-pen-up plot 0]"
