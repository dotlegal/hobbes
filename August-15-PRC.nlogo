...
to setup
  ...
  set d-rate2 precision (100 * (last c-d / item 1 popsizes)) 5 ;; @@@@@@@@@@@@@@
end
...
990
310
Graph 2: New Cases/30 and New Deaths (red) combined
weeks
people 
0.0
34.0
