...
to setup
  ...
  set d-rate2 precision (100 * (last c-d / item 5 popsizes)) 4 ;; @@@@@@@@@@@@@@
...
"" ""
PENS
"raster" 1.0 0 -3026479 true "" "if  ticks = 9 or ticks = 14 or ticks = 18 or ticks = 22\n[ plot-pen-up plotxy ticks 0 \n  plot-pen-down plotxy ticks 11110000]"
...
982
340
Graph 2: New Cases/7 and New Deaths (red) per week
weeks
people 
0.0
34.0
