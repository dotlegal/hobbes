...
to setup
  ...
  set d-rate2 (100 * (last c-d / item 3 popsizes)) ;; @@@@@@@@@@@@@@
...
982
340
Graph 2: New Cases / 4 with New Deaths (red )per wek
weeks
people 
0.0
34.0
...
"pen-2" 1.0 0 -2674135 true "" "ifelse ticks > root-shft and ticks <= (xmax) \n[plot-pen-down plot item ticks d-d ] \n[plot-pen-up plot 0]"
